...
import com.opengl.vr.data.IndexBuffer;
import com.opengl.vr.data.VertexBuffer;
import com.opengl.vr.programs.HeightmapShaderProgram;

import com.opengl.vr.util.Geometry;
...
public class Heightmap {
    ...
    private static final int STRIDE =
            TOTAL_COMPONENT_COUNT * BYTES_PER_FLOAT;
    ...
    private float[] loadBitmapData(Bitmap bitmap) {
        ...
        for (int row = 0; row < height; row++) {
            for (int col = 0; col < width; col++) {
               ...
               // heightmapVertices[offset++] = point.x + 0.5f;
               // heightmapVertices[offset++] = 0.5f - point.z;
            }
        }
