...
public class ObjectReader {
    ...
    public static void read(InputStream stream, Object3D obj3D) {
    ...
    public static List<Object3D> readMultiObj(Context context, String file) {
        boolean isAssets;
        ArrayList<Object3D> data  = new ArrayList<>();
        ...
        HashMap<String, Object3D> mObjs = new HashMap<>();
        Object3D nowObj = null;
        MtlInfo  nowMtl = null;
        try {
            String parent;
        ...
        for (Map.Entry<String, Object3D> stringObj3DEntry : mObjs.entrySet()) {
            Object3D obj = stringObj3DEntry.getValue();
            data.add(obj);
            obj.dataLock();
        }
        return data;
